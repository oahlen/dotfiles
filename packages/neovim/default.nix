...
let
  ...
  tokyonight-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e150aaabd119b8be7d9956637c3c3c0159f0fb32";
      sha256 = "sha256-dWYPCkYVpbaKLj0Bs3/COpgvhkiXqOhhP4Iz7KQaWc8=";
    };
  ...
  edge-nvim = vimUtils.buildVimPlugin {
    ...
    src = fetchFromGitHub {
      owner = "oahlen";
      repo = "edge.nvim";
      rev = "f0f2ba9be7ce18ef00d26c2f489f4f450184e6ee";
      sha256 = "sha256-mnI8+bRaaLAERsAloWYwBrBvmDstPGNPFWjAbz7iNVM=";
    };
