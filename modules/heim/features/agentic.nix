...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    features.agentic.stickyPromptLines = [
      "When writing documentation, keep typical AI-sounding text and bullet style lists to a minimum and adhere to existing style. Never use em dashes or mannered prose."
    ];
